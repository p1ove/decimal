...
START_TEST(s21_add_15) {
  ...
  src2.bits[0] = 0b00111111011101000111010111010100;
...
START_TEST(s21_add_29) {
  ...
  src1.bits[0] = 0b11000101101011101001010101100000;
  src1.bits[1] = 0b01001010001111100010010101101111;
  src1.bits[2] = 0b00000000000000100101000010100011;
  src1.bits[3] = 0b00000000000110000000000000000000;
  src2.bits[0] = 0b11000101101011101001010101100000;
  src2.bits[1] = 0b01001010001111100010010101101111;
  src2.bits[2] = 0b00000000000000100101000010100011;
  src2.bits[3] = 0b00000000000110000000000000000000;
  value_type_result = s21_add(src1, src2, &result);
  value_type_origin = 0;
  origin.bits[0] = 0b10001011010111010010101011000000;
  origin.bits[1] = 0b10010100011111000100101011011111;
  origin.bits[2] = 0b00000000000001001010000101000110;
...
START_TEST(dec_to_float_12) {
  ...
  number.bits[2] = 0b00000000000000000000000000000000;
  number.bits[3] = 0b10000000000000000000000000000000;
  // 1001001100110100101000000111000101
...
START_TEST(s21_from_float_to_decimal_9) {
  s21_decimal x;
  s21_decimal res = {{1000000, 0, 0, 6 << 16}};
  float y = 1.0;
  float z;
  ck_assert_int_eq(s21_from_float_to_decimal(y, &x), 0);
  for (int i = 0; i < 4; i++) {
